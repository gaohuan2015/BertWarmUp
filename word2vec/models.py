...
class SkipGramModel(tn.Module):
    ...
    def __init__(self, device, vocabulary_size, embedding_dim, neg_num=0, word_count=[]):
        ...
        self.embeddings = tn.Embedding(vocabulary_size, embedding_dim)
...
class CBOWModel(tn.Module):
    ...
    def __init__(self, device, vocabulary_size, embedding_dim):
        ...
        initrange = 0.5 / embedding_dim
        self.embeddings.weight.data.uniform_(-initrange, initrange)
        self.linear1 = tn.Linear(embedding_dim, vocabulary_size)
